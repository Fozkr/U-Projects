...
#define SC_Exec		2
#define SC_Join		3
#define SC_Create	4				// Check
#define SC_Open		5				// Check
...
#define SC_SemSignal	13			// Check DECIRLE AL PROFE QUE REVISE
#define SC_SemWait		14          // Check DECIRLE AL PROFE QUE REVISE
